...
exports._getInferenceURL = _getInferenceURL;
exports._getInferenceClient = _getInferenceClient;
exports._getChatCompletionsClient = _getChatCompletionsClient;
exports._getEmbeddingClient = _getEmbeddingClient;
exports._getImageEmbeddingClient = _getImageEmbeddingClient;
exports._getAzureOpenAIClient = _getAzureOpenAIClient;
const tslib_1 = require("tslib");
/* eslint-disable tsdoc/syntax */
const ai_inference_1 = tslib_1.__importDefault(require("@azure-rest/ai-inference"));
 ...
 */
function _getInferenceClient(context, options) {
    var _a, _b;
    ...
    const client = (0, ai_inference_1.default)(url, credential, clientOptions);
    return client;
}
/**
 ...
 */
function _getChatCompletionsClient(context, options) {
 ...
 */
function _getEmbeddingClient(context, options) {
    const inferenceClient = _getInferenceClient(context, options);
 ...
 */
function _getImageEmbeddingClient(context, options) {
    const inferenceClient = _getInferenceClient(context, options);
